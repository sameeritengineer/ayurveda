...
class UserCancelledOrderDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\UserCancelledOrderDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Order $model): QueryBuilder
    {
        return $model->where('user_id', Auth::user()->id)->where('order_status', 'canceled')->newQuery();
    }
    ...
    {
        return 'UserCancelledOrder_' . date('YmdHis');
    }
}
