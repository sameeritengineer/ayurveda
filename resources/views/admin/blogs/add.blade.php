                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="name" value="{{ old('name', $type == 2 ? $blog->name : '') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                <label>Slug</label>
                                <input type="text"
                                    class="form-control @if ($errors->has('slug')) is-invalid @endif" name="slug"
                                    id="slug" value="{{ old('slug', $type == 2 ? $blog->slug : '') }}">
                                @if ($errors->has('slug'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('slug') }}
                                    </div>
                                ...
                                <select class="form-control" name="category_id">
                                    ...
                                    @foreach ($categories as $cats)
                                        <option value="{{ $cats->id }}"
                                            {{ $type == 2 && $cats->id == $blog->category->id ? 'selected' : '' }}>
                                            {{ $cats->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="meta_title" name="meta_title"
                                    value="{{ old('meta_title', $type == 2 ? $blog->meta_title : '') }}" maxlength="60">
                            </div>
                            <div class="form-group">
                                <label for="meta_description">Meta Description:</label>
                                <input class="form-control" type="text" id="meta_description" name="meta_description"
                                    value="{{ old('meta_description', $type == 2 ? $blog->meta_description : '') }}"
                                    maxlength="160">
                            </div>
                            <div class="form-group">
                                <label for="meta_keywords">Meta Keywords:</label>
                                <input class="form-control" type="text" id="meta_keywords" name="meta_keywords"
                                    value="{{ old('meta_keywords', $type == 2 ? $blog->meta_keywords : '') }}"
                                    maxlength="255">
                            </div>
                            <div class="form-group">
                                <div class="control-label">Toggle switch single</div>
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" value="{{ $type == 2 && $blog->status == 1 ? 1 : 0 }}"
                                        name="custom_status" class="custom-switch-input"
                                        {{ $type == 2 && $blog->status == 1 ? 'checked' : '' }}>
